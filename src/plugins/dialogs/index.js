...
const Plugin = {
  install (Vue, options = {}) {
    ...
    const mergeParams = (p) => {
      const params = {}
      params.language = typeof options.language === 'string' ? options.language : 'en'
      if (typeof options.dialogCloseButton === 'boolean') params.dialogCloseButton = options.dialogCloseButton
      if (typeof options.dialogConfirmButton === 'boolean') params.dialogConfirmButton = options.dialogConfirmButton
